...
import one.digitalinnovation.notescontentprovider.database.NotesDatabaseHelper.Companion.DESCRIPTION_NOTES
import one.digitalinnovation.notescontentprovider.database.NotesDatabaseHelper.Companion.TITLE_NOTES
import one.digitalinnovation.notescontentprovider.database.NotesProvider.Companion.URI_NOTES
